...
const VOCABULARY = [
  ...
  ...[
    ...
    { id: "flash", fx: "white_blast", slot: "on", dur: 1, bold: "accent", occ: [],
      ...
      moment: { key_change: 0.9, tempo_change: 0.9, register_shift: 0.6, mood_turn: 0.6, entrance: 0.5, accent: 0.9, change: 0.8, highlight: 0.8, release: 0.5, transition: 0.6, light: 1, firm: 0.6, heavy: 0.2, _default: 0 } },
    { id: "hush", fx: "pause", slot: "span", dur: 4, bold: "accent", occ: [],
      ...
      moment: { breakdown: 1, mood_turn: 0.6, pause: 1, heavy: 1, firm: 1, light: 1, _default: 0 } },
    { id: "hook_lift", fx: "hook", slot: "span", dur: 4, bold: "accent", occ: [],
      ...
      moment: { register_shift: 1, mood_turn: 0.7, hook: 1, heavy: 1, firm: 1, light: 0.8, _default: 0 } },
    ...
    { id: "exit_dip", fx: "modulate", slot: "span", dur: 4, bold: "ambient", occ: [], params: { gain: 0.75, motion: -0.2, doing: "exit" },
      ...
      moment: { exit: 1, breakdown: 0.7, mood_turn: 0.5, heavy: 1, firm: 1, light: 1, _default: 0 } },
