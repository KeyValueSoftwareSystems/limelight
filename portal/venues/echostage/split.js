...
module.exports = function split(params, ctx) {
  ...
  function render(lane_values) {
    ...
    if (params.head !== false) H.setHead(frame, H.HEADS[2], { level: lv * 0.35, colour: colours[0], pan: 0.42 });
    if (params.head !== false) H.setHead(frame, H.HEADS[3], { level: rv * 0.35, colour: colours[1], pan: 0.58 });
    return frame;
  }
