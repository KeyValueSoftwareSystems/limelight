...
const variants: Record<Variant, string> = {
  ...
  primary: `${base} mat-accent-key gloss inline-flex items-center h-[var(--hit)] px-[18px] rounded-[var(--radius-sm)] text-[13px] font-semibold`,
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = "default", active, wide, className = "", style, ...props }, ref) => {
    ...
    const mat = variant === "primary" ? "" : active ? "mat-on" : "mat-key";
