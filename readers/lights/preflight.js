...
const VOCABULARY = [
  ...
  ...[
    { id: "impact", fx: "white_blast", slot: "on", dur: 1, bold: "hero", occ: [],
      ...
      moment: { drop: 1, peak: 1, entrance: 1, vocal_return: 0.7, melody_resume: 0.6, release: 0.9, accent: 0.7, change: 0.5, transition: 0.6, highlight: 0.6, breakdown: 0.2, heavy: 1, firm: 0.7, light: 0.3, _default: 0 } },
    { id: "breath", fx: "blackout", slot: "before", dur: 1, bold: "hero", occ: [],
      ...
      moment: { drop: 1, breakdown: 0.6, build: 0.3, entrance: 1, vocal_out: 0.5, spotlight: 0.3, release: 0.6, heavy: 1, firm: 0, light: 0, _default: 0 } },
    { id: "flash", fx: "white_blast", slot: "on", dur: 1, bold: "accent", occ: [],
      ...
      moment: { tempo_change: 0.9, register_shift: 0.6, entrance: 0.5, harmonic_rhythm: 0.7, vocal_return: 0.8, melody_resume: 0.7, accent: 0.9, change: 0.8, highlight: 0.8, release: 0.5, transition: 0.6, light: 1, firm: 0.6, heavy: 0.2, _default: 0 } },
    { id: "hush", fx: "pause", slot: "span", dur: 4, bold: "accent", occ: [],
      ...
      moment: { breakdown: 1, pause: 1, spotlight: 0.9, vocal_out: 0.7, heavy: 1, firm: 1, light: 1, _default: 0 } },
    { id: "hook_lift", fx: "hook", slot: "span", dur: 4, bold: "accent", occ: [],
      ...
      moment: { register_shift: 1, hook: 1, spotlight: 0.8, vocal_return: 0.9, heavy: 1, firm: 1, light: 0.8, _default: 0 } },
    ...
    { id: "fill_flicker", fx: "accent_strobe", slot: "span", dur: 4, bold: "accent", occ: ["pars:strobe"],
      ...
      moment: { rhythm_change: 1, build: 0.5, fill: 1, harmonic_rhythm: 0.6, heavy: 1, firm: 1, light: 0.7, _default: 0 } },
