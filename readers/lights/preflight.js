...
const VOCABULARY = [
  ...
  ...[
    ...
    { id: "flash", fx: "white_blast", slot: "on", dur: 1, bold: "accent", occ: [],
      ...
      moment: { key_change: 0.9, tempo_change: 0.9, lift: 0.6, mood_turn: 0.6, entrance: 0.5, accent: 0.9, change: 0.8, highlight: 0.8, release: 0.5, transition: 0.6, light: 1, firm: 0.6, heavy: 0.2, _default: 0 } },
    ...
    { id: "hook_lift", fx: "hook", slot: "span", dur: 4, bold: "accent", occ: [],
      ...
      moment: { lift: 1, mood_turn: 0.7, hook: 1, heavy: 1, firm: 1, light: 0.8, _default: 0 } },
