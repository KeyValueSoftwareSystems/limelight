...
def brief_for(song, overview, effects_block, hub, rig="arc4-head"):
    ...
    return "\n".join(
        [
            ...
            "  a palette         at most 6 colour FAMILIES hold the show. Families, not",
            "                    shades: a crossfade between two palette colours passes",
            "                    through in-between hues and those are ignored, so a",
            "                    tint, a shift or a spectrum costs you nothing here.",
            "                    Do NOT avoid colour effects to protect this number.",
