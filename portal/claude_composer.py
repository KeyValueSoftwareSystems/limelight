    ...
    return "\n".join(
        [
            ...
            *[f"  {nm:24s} {'' if t is None else f'{t:7.1f}s'}  {note}"
            ...
            "",
            "The rig is a symmetric object: four pars in a row and a head above them.",
            "Pars 1 and 4 are a mirror pair, 2 and 3 are the inner pair, and `extent`",
            "takes all, inner, outer, left, right, ends or single. A designer works",
            "those as groups and moves light across them - a figure that starts at one",
            "end and arrives at the other, a pair answering a pair, the head leading or",
            "following the pars. Four lamps doing unrelated things is not coordination,",
            "and neither is four lamps doing the same thing.",
            "",
            ...
            "",
            "Measured on the last show against the hand-built reference for this song:",
            "",
            "      all four lamps lit at once   ours 89.3%   reference 60.7%",
            "      a lamp at true black          ours  9.5%   reference 24.5%",
            "      states in the whole show      ours  7      reference 72",
            "",
            "Seven states over two minutes is seven looks. The reference changes its",
            "resting look about every other bar, and a good share of those looks are",
            "some of the rig off. That difference is not brightness or colour or",
            "effect choice - it is how many times the room changes and how often part",
            "of it is out.",
            "",
            ...
            "",
            "This is the difference between a show and a reactive rig, and it is the",
            "thing that has been wrong. Until now a cue could only sit on a measured",
            "moment - this song has 17 of them - so everything else had to be a",
            "That is a rig reacting to a waveform, and it reads as a broken streetlight.",
            "",
            "      show                     lands on a beat",
            "      hand-built reference          81.3%",
            "      55 bumps placed on bar lines 100.0%",
            "",
            "note. It is not how to fill a song. Density comes from many sharp cues on",
            "the grid: the reference carries 117 of them in two minutes, we have been",
            "writing about 40.",
            "",
