...
/* ONE PORT.
   ...
   isn't a page -- /api/... and /audio/... -- is forwarded to the portal behind
   the scenes, and the browser only ever talks to this one address.
   ...
   from. That is what makes this work in dev, behind a proxy, and in production
