    ...
    return "\n".join(
        [
            ...
            *[f"  bar {b:3d}  {t:6.1f}s  loud {p:3d}%  hits {n:2d}  {', '.join(names)}"
            ...
            "binding on the grid measured 18.4% of its rises within 60ms of a beat",
            ...
            *[f"  {t:4d}s  loud {p:3d}%  hits {n:2d}  b{nb} d{nd}  {', '.join(names)}"
            ...
            "binding, and a binding samples an audio envelope every frame. Measured on",
            "the last show: deleting the bindings removed 86% of all visible change.",
            "That is a rig reacting to a waveform, and it reads as a broken streetlight.",
            "",
            "      show                     lands on a beat",
            "      ours, mostly bindings         61.1%",
            "      hand-built reference          81.3%",
            "      55 bumps placed on bar lines 100.0%",
            "",
            "A binding is for something genuinely continuous - a swell under a held",
